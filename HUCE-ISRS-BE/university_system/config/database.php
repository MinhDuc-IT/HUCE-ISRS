...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // SQLite dùng cho bảng api_clients (không phải DB trường)
        'sqlite' => [
            'driver' => 'sqlite',
            'url' => env('DB_URL'),
        ...
        // SQL Server – kết nối tới DB trường đã restore từ .bak (read-only)
        'sqlsrv' => [
            'driver'   => 'sqlsrv',
            'url'      => env('DB_URL'),
            'host'     => env('DB_SQLSRV_HOST', '127.0.0.1'),
            'port'     => env('DB_SQLSRV_PORT', '1433'),
            'database' => env('DB_SQLSRV_DATABASE', 'EDU_NUCE'),
            'username' => env('DB_SQLSRV_USERNAME', 'sa'),
            'password' => env('DB_SQLSRV_PASSWORD', 'M@tKhauManh2026!'),
